...
public class UIButtonInspector : Editor
{
    ...
    #region Properties
    UIButton GetUIButton { get { if (uiButton == null) uiButton = (UIButton)target; return uiButton; } }
    #endregion
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (newButtonName == false && renameButtonName == false && deleteButtonName == false)
        {
            ...
            if (sp_backButton.boolValue == true && GetUIButton.buttonName.Equals("Back") == false) //CASE: we just ticked the 'Is Back Button' and the buttonNameCurrentIndex is not set to the 'Back' button --> we set the index to the 'Back' button
            {
                ...
                GetUIButton.buttonNameReference = UIManager.GetDoozyUIData.buttonNames[UIManager.GetIndexForButtonName("Back")]; //we reference the class not the value (we need a reference)
            ...
            {
                GetUIButton.buttonNameReference = UIManager.GetDoozyUIData.buttonNames[UIManager.GetIndexForButtonName(UIManager.DEFAULT_BUTTON_NAME)]; //we reference the class not the value (we need a reference)
                GetUIButton.buttonName = GetUIButton.buttonNameReference.buttonName;
            }

            if (UIManager.GetIndexForButtonName(GetUIButton.buttonName) == -1)
            {
                DoozyUIRedundancyCheck.UIButtonRedundancyCheck(GetUIButton);
            }
            buttonNameCurrentIndex = UIManager.GetIndexForButtonName(GetUIButton.buttonName); //we get the index for the current button name (if there is an error, it will be set to the default button name)
            buttonNameCurrentIndex = EditorGUILayout.Popup(buttonNameCurrentIndex, buttonNames, GUILayout.Width(200));
            GetUIButton.buttonNameReference = UIManager.GetDoozyUIData.buttonNames[buttonNameCurrentIndex]; //we reference the class not the value (we need a reference)
            GetUIButton.buttonName = GetUIButton.buttonNameReference.buttonName;
        ...
        if (newButtonName == false && renameButtonName == false && deleteButtonName == false)
        {
            ...
            {
                if (GetUIButton.buttonName.Equals(UIManager.DEFAULT_BUTTON_NAME))
                {
                ...
                if (UIManager.isNavigationEnabled)
                {
                    if (sp_backButton.boolValue == false
                        ...
                        && GetUIButton.buttonName.Equals(UIManager.DEFAULT_BUTTON_NAME) == false)
                    {
        ...
        else if (newButtonName == true)
        {
            ...
            if (GUILayout.Button("confirm", GUILayout.Width(98), GUILayout.Height(16)))
            {
                ...
                GetUIButton.buttonNameReference = UIManager.GetDoozyUIData.buttonNames[UIManager.GetIndexForButtonName(tempButtonNameString)]; //we update the reference
                GetUIButton.buttonName = GetUIButton.buttonNameReference.buttonName;
                DoozyUIRedundancyCheck.CheckAllTheUIButtons();
        ...
        else if (deleteButtonName == true)
        {
            ...
            {
                if (GetUIButton.buttonNameReference.buttonName.Equals(UIManager.DEFAULT_BUTTON_NAME))
                {
                ...
                else
                {
                    ...
                    GetUIButton.buttonNameReference = UIManager.GetDoozyUIData.buttonNames[buttonNameCurrentIndex]; //we update the buttonName reference
                    GetUIButton.buttonName = GetUIButton.buttonNameReference.buttonName;
                    DoozyUIRedundancyCheck.CheckAllTheUIButtons();
                }
                UpdateButtonNamesPopup();
        ...
        if (newButtonSound == false && renameButtonSound == false && deleteButtonSound == false)
        {
            ...
            if (UIManager.GetIndexForButtonSound(GetUIButton.onClickSound) == -1)
            {
                DoozyUIRedundancyCheck.UIButtonRedundancyCheck(GetUIButton);
            }
            buttonSoundCurrentIndex = UIManager.GetIndexForButtonSound(GetUIButton.onClickSound);
            buttonSoundCurrentIndex = EditorGUILayout.Popup(buttonSoundCurrentIndex, buttonSounds, GUILayout.Width(200));
            GetUIButton.onClickSoundReference = UIManager.GetDoozyUIData.buttonSounds[buttonSoundCurrentIndex]; //we reference the class not the value (we need a reference)
        ...
        if (newButtonSound == false && renameButtonSound == false && deleteButtonSound == false)
        {
            if (GetUIButton.onClickSoundReference.onClickSound.Equals(UIManager.DEFAULT_SOUND_NAME))
            {
                if (GUILayout.Button("new", GUILayout.Width(200), GUILayout.Height(16)))
                {
        ...
        else if (newButtonSound == true)
        {
            ...
            if (GUILayout.Button("confirm", GUILayout.Width(98), GUILayout.Height(16)))
            {
                ...
                GetUIButton.onClickSoundReference = UIManager.GetDoozyUIData.buttonSounds[UIManager.GetIndexForButtonSound(tempButtonSoundString)];    //we update the reference
                GetUIButton.onClickSound = GetUIButton.onClickSoundReference.onClickSound;
        ...
        else if (deleteButtonSound == true)
        {
            ...
            if (GUILayout.Button("yes", GUILayout.Width(98), GUILayout.Height(16)))
            {
                ...
                else
                {
                    ...
                    GetUIButton.onClickSoundReference = UIManager.GetDoozyUIData.buttonSounds[buttonSoundCurrentIndex]; //we update the element name reference
                    GetUIButton.onClickSound = GetUIButton.onClickSoundReference.onClickSound;
                    DoozyUIRedundancyCheck.CheckAllTheUIButtons();
                }
                UpdateButtonSoundsPopup();
        ...
        if (UIManager.isNavigationEnabled && sp_backButton.boolValue == false)
        {
            ...
            if (GUILayout.Button("add element", GUILayout.Width(224)))
            {
                ...
                GetUIButton.showElements.Add(UIManager.DEFAULT_ELEMENT_NAME);
                showElementsIndex.Add(UIManager.GetIndexForElementName(GetUIButton.showElements[GetUIButton.showElements.Count - 1]));
            }
            ...
            if (GUILayout.Button("add element", GUILayout.Width(224)))
            {
                ...
                GetUIButton.hideElements.Add(UIManager.DEFAULT_ELEMENT_NAME);
                hideElementsIndex.Add(UIManager.GetIndexForElementName(GetUIButton.hideElements[GetUIButton.hideElements.Count - 1]));
            }
