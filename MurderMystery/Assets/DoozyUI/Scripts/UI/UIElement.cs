    ...
    public class UIElement : MonoBehaviour
    {
        ...
        public UIAnimator.InitialData GetInitialData
        {
            get
            {
                ...
                initialData.startAnchoredPosition = startAnchoredPosition;
        ...
        void SetupElement()
        {
            ...
            {
                UIManager.HideUiElement(elementName, true, disableWhenHidden); //ENABLED in 2.3.1
                //Hide(true); //DISABELD in 2.3.1
            }
        }
        #endregion
