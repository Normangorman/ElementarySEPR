...
namespace DoozyUI
{
    ...
    public class UIEffect : MonoBehaviour
    {
        ...
        public void UpdateEffectSortingOrder()
        {
            ...
            targetSortingLayerID = targetUIElement.transform.GetComponent<Canvas>().sortingLayerID;
            targetSortingOrder = targetUIElement.transform.GetComponent<Canvas>().sortingOrder;
